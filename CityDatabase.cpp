...
LinkBasedQueue<City*>* CityDatabase::recommendCities(int numRecommendations, double curX, double curY, double distance, int popDens, double livingIndex, std::string climate, std::string language, std::string activities, std::string country) {
